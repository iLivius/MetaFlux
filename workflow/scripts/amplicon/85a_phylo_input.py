...
def main() -> int:
    ...
    record = {
        ...
        "min_asvs": min_asvs,
        # Two orders, both worth recording: the abundance order the taxonomy table
        # carries, and the sequence-sorted order this FASTA was actually written in.
        "asv_ids": table_ids,
        "fasta_order": write_order,
        "asv_lengths": lengths,
        "checksums": {
